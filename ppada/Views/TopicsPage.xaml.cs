...
namespace ppada.Views
{
    ...
    public sealed partial class TopicsPage : Page
    {
        ...
        private void TopicItemGrid_Tapped(object sender, TappedRoutedEventArgs e)
        {
            Grid SelectedGrid = (Grid)sender;
            Topic SelectedTopic = (Topic)SelectedGrid.DataContext;
            Note foundNote = App.vm.GetTopicNote(SelectedTopic.id);
            Frame.Navigate(typeof(NotePage), foundNote.id);
